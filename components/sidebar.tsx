      ...
      <div className="px-3 py-2.5 sm:px-4 sm:py-3 border-b border-sidebar-border flex items-center justify-between gap-2">
        {isOpen && (
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 flex-1 min-w-0">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-sidebar-primary/20 flex items-center justify-center flex-shrink-0">
              <MessageCircle className="h-4 w-4 sm:h-4.5 sm:w-4.5 md:h-5 md:w-5 text-sidebar-primary" />
            </div>
