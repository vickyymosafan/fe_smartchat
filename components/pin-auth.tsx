      ...
      >
        ...
        >
          <motion.div
            ...
            className="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center mb-4 shadow-lg shadow-primary/50 p-3"
          >
            <img 
              src="/smartchat4.png" 
              alt="SmartChat Logo" 
